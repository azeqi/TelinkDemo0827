package worker.seedmorn.com.telinkdemo0827.app;
...
import worker.seedmorn.com.telinkdemo0827.ui.TempTestActivity;
import worker.seedmorn.com.telinkdemo0827.utils.FileSystem;

public class TelinkMyApplication extends TelinkApplication {
    private Mesh mesh;
    private StringBuilder logInfo;
    private static TelinkMyApplication thiz;
...
//        AdvanceStrategy.setDefault(new MySampleAdvanceStrategy());
    ...
    public static TelinkMyApplication getApp() {
        return thiz;
    }

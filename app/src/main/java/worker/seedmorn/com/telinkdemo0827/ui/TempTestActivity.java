...
//    private int notifyCount = 0;
    ...
    private TelinkMyApplication app;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_info.setText("");
//        TelinkMyApplication.getApp().addEventListener(NotificationEvent.ONLINE_STATUS, this);
        TelinkMyApplication.getApp().addEventListener(NotificationEvent.ONLINE_STATUS, this);
        TelinkMyApplication.getApp().addEventListener(DeviceEvent.STATUS_CHANGED, this);

        app = TelinkMyApplication.getApp();
        ...
        TestInput testInput = TelinkMyApplication.getApp().getTestInput();
        if (testInput != null) {
        ...
        curDevice = TelinkMyApplication.getApp().getConnectDevice();
//        if (curDevice == null)
    ...
    protected void onDestroy() {
        super.onDestroy();
        TelinkMyApplication.getApp().removeEventListener(this);
...
//                notifyCount = 0;
                    ...
                    TelinkMyApplication.getApp().setTestInput(testInput);
